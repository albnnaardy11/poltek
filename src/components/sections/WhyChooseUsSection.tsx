...
export default function WhyChooseUsSection() {
  return (
    <section className="w-full section-padding bg-gray-50/50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-black text-[#1D234E] leading-tight mb-4 sm:mb-6 heading-tracking">
